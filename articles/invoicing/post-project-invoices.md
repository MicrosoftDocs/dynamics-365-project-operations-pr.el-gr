...
description: Αυτό το άρθρο παρέχει μια επισκόπηση διαδικασιών τιμολόγησης στο Project Operations για μη εφοδιασμένα σενάρια ή σενάρια βασισμένα σε πόρους.
author: sigitac
ms.date: 01/29/2021
ms.topic: overview
