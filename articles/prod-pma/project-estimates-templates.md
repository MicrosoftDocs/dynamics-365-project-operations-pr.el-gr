...
description: Αυτό το θέμα περιγράφει τα πρότυπα και τις υποκείμενες εργασίες που χρησιμοποιούνται για το συγχρονισμό των εκτιμήσεων ώρας και τις εκτιμήσεις δαπανών έργου από το Dynamics 365 Finance του Microsoft Dynamics 365 Project Service Automation.
author: Yowelle
ms.date: 07/20/2018
ms.topic: article
ms.prod: ''
...
Αυτό το θέμα περιγράφει τα πρότυπα και τις υποκείμενες εργασίες που χρησιμοποιούνται για το συγχρονισμό των εκτιμήσεων ώρας και τις εκτιμήσεις δαπανών έργου από το Dynamics 365 Finance του Dynamics 365 Project Service Automation.
...
Στο πρότυπο εκτιμήσεων ωρών έργου, πρέπει να χρησιμοποιήσετε το Microsoft Power Query για Excel για να ολοκληρώσετε αυτές τις εργασίες:
...
- Εάν δημιουργείτε ένα νέο πρότυπο, πρέπει να προσθέσετε αυτήν τη στήλη. Στο Power Query, επιλέξτε **Προσθήκη στήλης υπό όρους** και καταχωρήστε ένα όνομα για τη νέα στήλη, όπως το **ModelID**. Εισάγετε τη συνθήκη για τη στήλη, όπου, εάν η εργασία έργου είναι null, τότε \<enter the forecast model ID\>; else null.
...
Στο πρότυπο εκτιμήσεων δαπανών έργου, πρέπει να χρησιμοποιήσετε το Power Query για να ολοκληρώσετε τις ακόλουθες εργασίες:
...
- Αν χρησιμοποιείτε τις προεπιλεγμένες εκτιμήσεις εξόδων έργου (PSA σε Fin και Ops), στο στοιχείο, Power Query, επιλέξτε την πρώτη **συνθήκη που εισαγάγατε** από την ενότητα **Εφαρμοσμένα βήματα**. Στην καταχώριση **Συνάρτηση**, αντικαταστήστε το **O\_forecast** με το όνομα του αναγνωριστικού μοντέλου πρόβλεψης που θα πρέπει να χρησιμοποιηθεί με την ενοποίηση. Το προεπιλεγμένο πρότυπο έχει ένα αναγνωριστικό μοντέλου πρόβλεψης από τα δεδομένα επίδειξης.
- Εάν δημιουργείτε ένα νέο πρότυπο, πρέπει να προσθέσετε αυτήν τη στήλη. Στο Power Query, επιλέξτε **Προσθήκη στήλης υπό όρους** και καταχωρήστε ένα όνομα για τη νέα στήλη, όπως το **ModelID**. Εισάγετε τη συνθήκη για τη στήλη, όπου, εάν το αναγνωριστικό γραμμής εκτίμησης είναι null, τότε \<enter the forecast model ID\>; else null.
