...
description: Αυτό το άρθρο παρέχει συνήθη μοτίβα για τη χρήση επεκτάσεων για την υλοποίηση προσαρμοσμένων πεδίων.
author: Yowelle
ms.date: 05/29/2019
ms.topic: article
ms.prod: ''
...
Αυτό το άρθρο παρέχει συνήθη μοτίβα για τη χρήση επεκτάσεων για την υλοποίηση προσαρμοσμένων πεδίων. Καλύπτονται τα ακόλουθα άρθρα:
...
Αυτό το άρθρο απευθύνεται σε προγραμματιστές που ενσωματώνουν τα προσαρμοσμένα πεδία Microsoft Dynamics 365 Project Timesheet στην εφαρμογή για φορητές συσκευές που είναι διαθέσιμη για Apple iOS και Google Android. Η υπόθεση είναι ότι οι αναγνώστες εξοικειώνονται με την ανάπτυξη X++ και τη λειτουργικότητα του φύλλου εργασίας του έργου.
...
- Εάν η ιδιότητα **stringOptions** παρέχεται στο αντικείμενο **TSTimesheetCustomField**, αυτά τα στοιχεία λίστας είναι οι μόνες τιμές που μπορούν να επιλέξουν οι χρήστες χρησιμοποιώντας τα κουμπιά επιλογής (κουμπιά επιλογής).
    ...
    Σε αυτήν την περίπτωση, το πεδίο συμβολοσειράς μπορεί να ενεργήσει ως τιμή απαρίθμησης για το σκοπό της καταχώρησης χρήστη. Για να αποθηκεύσετε την τιμή στη βάση δεδομένων ως απαρίθμηση, αντιστοιχήστε ξανά με μη αυτόματο τρόπο την τιμή της συμβολοσειράς στην τιμή απαρίθμησης προτού την αποθηκεύσετε στη βάση δεδομένων χρησιμοποιώντας ιεραρχική κλίμακα (ανατρέξτε στην ενότητα «Χρήση ιεραρχικής κλίμακας στην κλάση TSTimesheetEntryService για την αποθήκευση μιας καταχώρησης φύλλου κατανομής χρόνου από την εφαρμογή πίσω στη βάση δεδομένων» στη συνέχεια αυτού του άρθρου για ένα παράδειγμα).
...
Αυτή η ιδιότητα ισχύει μόνο όταν το **fieldBaseType** έχει οριστεί σε **Συμβολοσειρά**. Εάν έχει οριστεί το **stringOptions**, οι τιμές συμβολοσειράς που είναι διαθέσιμες για επιλογή μέσω των κουμπιών επιλογής (κουμπιά επιλογής) καθορίζονται από τις συμβολοσειρές που περιλαμβάνονται στη λίστα. Εάν δεν παρέχονται συμβολοσειρές, επιτρέπεται η καταχώρηση ελεύθερου κειμένου στο πεδίο συμβολοσειράς (ανατρέξτε στην ενότητα «Χρήση ιεραρχικής κλίμακας στην κλάση TSTimesheetEntryService για την αποθήκευση μιας καταχώρησης φύλλου κατανομής χρόνου από την εφαρμογή πίσω στη βάση δεδομένων» στη συνέχεια αυτού του άρθρου για ένα παράδειγμα).
