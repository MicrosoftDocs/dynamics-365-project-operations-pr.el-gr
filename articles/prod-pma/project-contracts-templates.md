...
description: Αυτό το θέμα περιγράφει το πρότυπο και τις υποκείμενες εργασίες που χρησιμοποιούνται για το συγχρονισμό συμβάσεων έργου και έργων απευθείας από το Dynamics 365 Finance του Microsoft Dynamics 365 Project Service Automation.
author: Yowelle
ms.date: 12/17/2020
ms.topic: article
ms.prod: ''
...
Αυτό το θέμα περιγράφει το πρότυπο και τις υποκείμενες εργασίες που χρησιμοποιούνται για το συγχρονισμό συμβάσεων έργου και έργων απευθείας από το Dynamics 365 Finance του Dynamics 365 Project Service Automation.
