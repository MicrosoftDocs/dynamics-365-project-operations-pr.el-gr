...
description: Αυτό το άρθρο παρέχει πληροφορίες σχετικά με τις ενημερώσεις ποιότητας που είναι διαθέσιμες στην έκδοση Νοεμβρίου 2020 του Project Operations για σενάρια βασισμένα σε εφοδιασμένη παραγωγή.
author: sigitac
ms.date: 10/15/2020
ms.topic: article
