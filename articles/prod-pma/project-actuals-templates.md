---
title: Συγχρονισμός των πραγματικών τιμών του έργου απευθείας από το Project Service Automation στο ημερολόγιο ενοποίησης έργου για καταχώρηση στις οικονομικές και επιχειρηματικές δραστηριότητες
description: Αυτό το άρθρο περιγράφει τα πρότυπα και τις υποκείμενες εργασίες που χρησιμοποιούνται για το συγχρονισμό των πραγματικών τιμών του έργου απευθείας από το Microsoft Dynamics 365 Project Service Automation στις οικονομικές και επιχειρηματικές δραστηριότητες.
author: Yowelle
ms.date: 07/20/2018
ms.topic: article
ms.prod: ''
...
[![Ροή δεδομένων για ενοποίηση του Project Service Automation με τις οικονομικές και επιχειρηματικές δραστηριότητες.](./media/ProjectActualsFlow.jpg)](./media/ProjectActualsFlow.jpg)
...
[![Αντιστοίχιση προτύπου - Ενημέρωση συναλλαγών.](./media/TransactionConnectionsUpdate.jpg)](./media/TransactionConnectionsUpdate.jpg)
