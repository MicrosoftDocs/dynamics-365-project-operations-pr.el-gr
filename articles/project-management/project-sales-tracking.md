...
description: Αυτό το άρθρο παρέχει πληροφορίες σχετικά με τον τρόπο με τον οποίο το Project Operations παρακολουθεί την πρόοδο των εσόδων εργασίας σε ένα έργο.
author: rumant
ms.date: 03/24/2021
ms.topic: article
