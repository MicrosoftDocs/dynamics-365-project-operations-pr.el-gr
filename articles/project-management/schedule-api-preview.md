...
<span data-ttu-id="f10d1-111">Ο παρακάτω πίνακας περιλαμβάνει μια πλήρη λίστα των **Οντοτήτων προγραμματισμού**.</span><span class="sxs-lookup"><span data-stu-id="f10d1-111">The following table provides a full list of the **Scheduling entities**.</span></span>
...
- <span data-ttu-id="f10d1-139">**msdyn_PSSDeleteV1**: αυτό το API μπορεί να χρησιμοποιηθεί για τη διαγραφή μιας οντότητας.</span><span class="sxs-lookup"><span data-stu-id="f10d1-139">**msdyn_PSSDeleteV1**: This API can be used to delete an entity.</span></span> <span data-ttu-id="f10d1-140">Η οντότητα μπορεί να είναι οποιαδήποτε από τις οντότητες προγραμματισμού που υποστηρίζουν τη λειτουργία διαγραφής.</span><span class="sxs-lookup"><span data-stu-id="f10d1-140">The entity can be any of the Scheduling entities that support the delete operation.</span></span>
...
| <span data-ttu-id="f10d1-198">msdyn_actualend</span><span class="sxs-lookup"><span data-stu-id="f10d1-198">msdyn_actualend</span></span>                        | <span data-ttu-id="f10d1-199">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-199">no</span></span>             | <span data-ttu-id="f10d1-200">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-200">no</span></span>               |
...
| <span data-ttu-id="f10d1-240">msdyn_ismilestonename</span><span class="sxs-lookup"><span data-stu-id="f10d1-240">msdyn_ismilestonename</span></span>                  | <span data-ttu-id="f10d1-241">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-241">no</span></span>             | <span data-ttu-id="f10d1-242">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-242">no</span></span>               |
...
| <span data-ttu-id="f10d1-483">msdyn_markedfordeletiontimer</span><span class="sxs-lookup"><span data-stu-id="f10d1-483">msdyn_markedfordeletiontimer</span></span>                     | <span data-ttu-id="f10d1-484">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-484">no</span></span>             | <span data-ttu-id="f10d1-485">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-485">no</span></span>           |
...
| <span data-ttu-id="f10d1-565">msdyn_finish</span><span class="sxs-lookup"><span data-stu-id="f10d1-565">msdyn_finish</span></span>                           | <span data-ttu-id="f10d1-566">ναι</span><span class="sxs-lookup"><span data-stu-id="f10d1-566">yes</span></span>            | <span data-ttu-id="f10d1-567">ναι</span><span class="sxs-lookup"><span data-stu-id="f10d1-567">yes</span></span>          |
...
| <span data-ttu-id="f10d1-607">msdyn_remainingcost</span><span class="sxs-lookup"><span data-stu-id="f10d1-607">msdyn_remainingcost</span></span>                    | <span data-ttu-id="f10d1-608">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-608">no</span></span>             | <span data-ttu-id="f10d1-609">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-609">no</span></span>           |
...
| <span data-ttu-id="f10d1-616">msdyn_remainingsales_base</span><span class="sxs-lookup"><span data-stu-id="f10d1-616">msdyn_remainingsales_base</span></span>              | <span data-ttu-id="f10d1-617">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-617">no</span></span>             | <span data-ttu-id="f10d1-618">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-618">no</span></span>           |
| <span data-ttu-id="f10d1-619">msdyn_replaylogheader</span><span class="sxs-lookup"><span data-stu-id="f10d1-619">msdyn_replaylogheader</span></span>                  | <span data-ttu-id="f10d1-620">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-620">no</span></span>             | <span data-ttu-id="f10d1-621">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-621">no</span></span>           |
| <span data-ttu-id="f10d1-622">msdyn_salesconsumption</span><span class="sxs-lookup"><span data-stu-id="f10d1-622">msdyn_salesconsumption</span></span>                 | <span data-ttu-id="f10d1-623">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-623">no</span></span>             | <span data-ttu-id="f10d1-624">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-624">no</span></span>           |
| <span data-ttu-id="f10d1-625">msdyn_salesestimateatcompleteeac</span><span class="sxs-lookup"><span data-stu-id="f10d1-625">msdyn_salesestimateatcompleteeac</span></span>       | <span data-ttu-id="f10d1-626">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-626">no</span></span>             | <span data-ttu-id="f10d1-627">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-627">no</span></span>           |
| <span data-ttu-id="f10d1-628">msdyn_salesestimateatcompleteeac_base</span><span class="sxs-lookup"><span data-stu-id="f10d1-628">msdyn_salesestimateatcompleteeac_base</span></span>  | <span data-ttu-id="f10d1-629">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-629">no</span></span>             | <span data-ttu-id="f10d1-630">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-630">no</span></span>           |
| <span data-ttu-id="f10d1-631">msdyn_salesvariance</span><span class="sxs-lookup"><span data-stu-id="f10d1-631">msdyn_salesvariance</span></span>                    | <span data-ttu-id="f10d1-632">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-632">no</span></span>             | <span data-ttu-id="f10d1-633">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-633">no</span></span>           |
| <span data-ttu-id="f10d1-634">msdyn_salesvariance_base</span><span class="sxs-lookup"><span data-stu-id="f10d1-634">msdyn_salesvariance_base</span></span>               | <span data-ttu-id="f10d1-635">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-635">no</span></span>             | <span data-ttu-id="f10d1-636">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-636">no</span></span>           |
| <span data-ttu-id="f10d1-637">msdyn_scheduleperformance</span><span class="sxs-lookup"><span data-stu-id="f10d1-637">msdyn_scheduleperformance</span></span>              | <span data-ttu-id="f10d1-638">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-638">no</span></span>             | <span data-ttu-id="f10d1-639">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-639">no</span></span>           |
| <span data-ttu-id="f10d1-640">msdyn_scheduleperformancename</span><span class="sxs-lookup"><span data-stu-id="f10d1-640">msdyn_scheduleperformancename</span></span>          | <span data-ttu-id="f10d1-641">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-641">no</span></span>             | <span data-ttu-id="f10d1-642">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-642">no</span></span>           |
| <span data-ttu-id="f10d1-643">msdyn_schedulevariance</span><span class="sxs-lookup"><span data-stu-id="f10d1-643">msdyn_schedulevariance</span></span>                 | <span data-ttu-id="f10d1-644">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-644">no</span></span>             | <span data-ttu-id="f10d1-645">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-645">no</span></span>           |
| <span data-ttu-id="f10d1-646">msdyn_taskearlieststart</span><span class="sxs-lookup"><span data-stu-id="f10d1-646">msdyn_taskearlieststart</span></span>                | <span data-ttu-id="f10d1-647">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-647">no</span></span>             | <span data-ttu-id="f10d1-648">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-648">no</span></span>           |
| <span data-ttu-id="f10d1-649">msdyn_teamsize</span><span class="sxs-lookup"><span data-stu-id="f10d1-649">msdyn_teamsize</span></span>                         | <span data-ttu-id="f10d1-650">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-650">no</span></span>             | <span data-ttu-id="f10d1-651">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-651">no</span></span>           |
| <span data-ttu-id="f10d1-652">msdyn_teamsize_date</span><span class="sxs-lookup"><span data-stu-id="f10d1-652">msdyn_teamsize_date</span></span>                    | <span data-ttu-id="f10d1-653">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-653">no</span></span>             | <span data-ttu-id="f10d1-654">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-654">no</span></span>           |
| <span data-ttu-id="f10d1-655">msdyn_teamsize_state</span><span class="sxs-lookup"><span data-stu-id="f10d1-655">msdyn_teamsize_state</span></span>                   | <span data-ttu-id="f10d1-656">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-656">no</span></span>             | <span data-ttu-id="f10d1-657">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-657">no</span></span>           |
| <span data-ttu-id="f10d1-658">msdyn_totalactualcost</span><span class="sxs-lookup"><span data-stu-id="f10d1-658">msdyn_totalactualcost</span></span>                  | <span data-ttu-id="f10d1-659">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-659">no</span></span>             | <span data-ttu-id="f10d1-660">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-660">no</span></span>           |
| <span data-ttu-id="f10d1-661">msdyn_totalactualcost_base</span><span class="sxs-lookup"><span data-stu-id="f10d1-661">msdyn_totalactualcost_base</span></span>             | <span data-ttu-id="f10d1-662">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-662">no</span></span>             | <span data-ttu-id="f10d1-663">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-663">no</span></span>           |
| <span data-ttu-id="f10d1-664">msdyn_totalplannedcost</span><span class="sxs-lookup"><span data-stu-id="f10d1-664">msdyn_totalplannedcost</span></span>                 | <span data-ttu-id="f10d1-665">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-665">no</span></span>             | <span data-ttu-id="f10d1-666">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-666">no</span></span>           |
| <span data-ttu-id="f10d1-667">msdyn_totalplannedcost_base</span><span class="sxs-lookup"><span data-stu-id="f10d1-667">msdyn_totalplannedcost_base</span></span>            | <span data-ttu-id="f10d1-668">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-668">no</span></span>             | <span data-ttu-id="f10d1-669">όχι</span><span class="sxs-lookup"><span data-stu-id="f10d1-669">no</span></span>           |


## <a name="limitations-and-known-issues"></a><span data-ttu-id="f10d1-670">Περιορισμοί και γνωστά προβλήματα</span><span class="sxs-lookup"><span data-stu-id="f10d1-670">Limitations and known issues</span></span>
<span data-ttu-id="f10d1-671">Ακολουθεί μια λίστα με περιορισμούς και γνωστά ζητήματα:</span><span class="sxs-lookup"><span data-stu-id="f10d1-671">The following is a list of limitations and known issues:</span></span>

- <span data-ttu-id="f10d1-672">Τα API προγραμματισμού μπορούν να χρησιμοποιηθούν μόνο από **Χρήστες με άδεια χρήσης του Microsoft Project.**</span><span class="sxs-lookup"><span data-stu-id="f10d1-672">Schedule APIs can only be used by **Users with Microsoft Project License.**</span></span> <span data-ttu-id="f10d1-673">Δεν είναι δυνατό να χρησιμοποιηθούν από:</span><span class="sxs-lookup"><span data-stu-id="f10d1-673">They can't be used by:</span></span>
    - <span data-ttu-id="f10d1-674">Χρήστες εφαρμογής</span><span class="sxs-lookup"><span data-stu-id="f10d1-674">Application users</span></span>
    - <span data-ttu-id="f10d1-675">Χρήστες συστήματος</span><span class="sxs-lookup"><span data-stu-id="f10d1-675">System users</span></span>
    - <span data-ttu-id="f10d1-676">Χρήστες ενοποίησης</span><span class="sxs-lookup"><span data-stu-id="f10d1-676">Integration users</span></span>
    - <span data-ttu-id="f10d1-677">Άλλοι χρήστες που δεν διαθέτουν την απαιτούμενη άδεια χρήσης</span><span class="sxs-lookup"><span data-stu-id="f10d1-677">Other users that don't have the required license</span></span>
- <span data-ttu-id="f10d1-678">Κάθε **OperationSet** μπορεί να έχει μέγιστο αριθμό 100 λειτουργιών.</span><span class="sxs-lookup"><span data-stu-id="f10d1-678">Each **OperationSet** can only have a maximum of 100 operations.</span></span>
- <span data-ttu-id="f10d1-679">Κάθε χρήστης μπορεί να έχει μόνο μέγιστο αριθμό 10 ανοιχτών **OperationSets**.</span><span class="sxs-lookup"><span data-stu-id="f10d1-679">Each user can only have a maximum of 10 open **OperationSets**.</span></span>
- <span data-ttu-id="f10d1-680">Το Project Operations υποστηρίζει πλέον το πολύ έως 500 συνολικές εργασίες σε ένα έργο.</span><span class="sxs-lookup"><span data-stu-id="f10d1-680">Project Operations currently supports a maximum of 500 total tasks on a project.</span></span>
- <span data-ttu-id="f10d1-681">Η κατάσταση αποτυχίας και τα αρχεία καταγραφής αποτυχίας του **OperationSet** δεν είναι αυτή τη στιγμή διαθέσιμα.</span><span class="sxs-lookup"><span data-stu-id="f10d1-681">**OperationSet** failure status and failure logs aren't currently available.</span></span>
- [<span data-ttu-id="f10d1-682">Όρια και περιορισμοί για έργα και εργασίες</span><span class="sxs-lookup"><span data-stu-id="f10d1-682">Limits and boundaries on projects and tasks</span></span>](/project-for-the-web/project-for-the-web-limits-and-boundaries)

## <a name="error-handling"></a><span data-ttu-id="f10d1-683">Χειρισμός σφαλμάτων</span><span class="sxs-lookup"><span data-stu-id="f10d1-683">Error handling</span></span>

   - <span data-ttu-id="f10d1-684">Για να εξετάσετε τα σφάλματα που δημιουργούνται από τα σύνολα λειτουργιών, μεταβείτε στην επιλογή **Ρυθμίσεις** \> **Προγραμματισμός ενοποίησης** \> **Σύνολα λειτουργιών**.</span><span class="sxs-lookup"><span data-stu-id="f10d1-684">To review errors generated from the Operation Sets, go to **Settings** \> **Schedule Integration** \> **Operations Sets**.</span></span>
   - <span data-ttu-id="f10d1-685">Για να εξετάσετε τα σφάλματα που δημιουργούνται από την υπηρεσία προγραμματισμού έργου, μεταβείτε στην επιλογή **Ρυθμίσεις** \> **Προγραμματισμός ενοποίησης** \> **Αρχεία σφαλμάτων PSS**.</span><span class="sxs-lookup"><span data-stu-id="f10d1-685">To review errors generated from the Project Scheduling Service, go to **Settings** \> **Schedule Integration** \> **PSS Error Logs**.</span></span>

## <a name="sample-scenario"></a><span data-ttu-id="f10d1-686">Δείγμα σεναρίου</span><span class="sxs-lookup"><span data-stu-id="f10d1-686">Sample scenario</span></span>

<span data-ttu-id="f10d1-687">Σε αυτό το σενάριο, θα δημιουργήσετε ένα έργο, ένα μέλος ομάδας, τέσσερις εργασίες και δύο αναθέσεις πόρων.</span><span class="sxs-lookup"><span data-stu-id="f10d1-687">In this scenario, you will create a project, a team member, four tasks, and two resource assignments.</span></span> <span data-ttu-id="f10d1-688">Στη συνέχεια, θα ενημερώσετε μία εργασία, θα ενημερώσετε το έργο, θα διαγράψετε μια εργασία, θα διαγράψετε μία ανάθεση πόρου και θα δημιουργήσετε μια εξάρτηση εργασίας.</span><span class="sxs-lookup"><span data-stu-id="f10d1-688">Next, you will update one task, update the project, delete one task, delete one resource assignment, and create a task dependency.</span></span>
...
## <a name="additional-samples"></a><span data-ttu-id="f10d1-689">Πρόσθετα δείγματα</span><span class="sxs-lookup"><span data-stu-id="f10d1-689">Additional samples</span></span>
