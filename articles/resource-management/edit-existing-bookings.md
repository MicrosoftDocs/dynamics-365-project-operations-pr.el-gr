...
description: Αυτό το άρθρο παρέχει πληροφορίες σχετικά με τον τρόπο ενημέρωσης και την πραγματοποίηση αλλαγών σε κρατήσεις.
author: ruhercul
ms.date: 11/12/2020
ms.topic: article
...
Όταν γίνονται αλλαγές σε ένα έργο και απαιτούν να ενημερώσετε τις υπάρχουσες κρατήσεις, υπάρχουν διάφοροι τρόποι για να κάνετε τις αλλαγές. Αυτό το άρθρο περιγράφει τον τρόπο ενημέρωσης και την πραγματοποίηση αλλαγών σε κρατήσεις.
