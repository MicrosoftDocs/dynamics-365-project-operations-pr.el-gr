...
description: Αυτό το άρθρο παρέχει πληροφορίες σχετικά με τον τρόπο λειτουργίας μεθόδων εκχώρησης κράτησης στο Project Operations.
author: ruhercul
ms.date: 09/23/2020
ms.topic: article
ms.prod: ''
