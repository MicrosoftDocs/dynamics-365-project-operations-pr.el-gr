...
description: Αυτό το άρθρο παρέχει πληροφορίες σχετικά με τις προσφορές και τις γραμμές προσφορών.
author: rumant
ms.custom:
...
Αυτό το άρθρο θα επικεντρωθεί στις λεπτομέρειες των προσφορών έργου.
