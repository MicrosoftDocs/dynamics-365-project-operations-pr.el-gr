...
description: Αυτό το άρθρο παρέχει πληροφορίες σχετικά με τον τρόπο ανάκλησης μιας συναλλαγής χρόνου ή δαπάνης που έχει εγκριθεί προηγουμένως.
author: rumant
ms.custom: ''
ms.author: rumant
ms.date: 03/08/2019
