...
description: Αυτό το θέμα παρέχει μια επισκόπηση της διαδικασίας αναβάθμισης από Microsoft Dynamics 365 Project Service Automation σε Dynamics 365 Project Operations.
author: ruhercul
...
Είμαστε ενθουσιασμένοι που θα ανακοινώσουμε την πρώτη από τις τρεις φάσεις για αναβάθμιση από το Microsoft Dynamics 365 Project Service Automation στο Dynamics 365 Project Operations. Αυτή θέμα παρέχει μια επισκόπηση για τους πελάτες που ξεκινούν αυτήν τη συναρπαστική διαδρομή. Τα μελλοντικά θέματα θα περιλαμβάνουν ζητήματα που αφορούν προγραμματιστές και λεπτομέρειες σχετικά με τις βελτιώσεις των δυνατοτήτων. Δεν παρέχουν μόνο οδηγίες που θα σας βοηθήσουν να προετοιμαστείτε για την αναβάθμιση σε Project Operations αλλά και θα σας εξηγούν τι μπορείτε να περιμένετε μετά την αναβάθμιση.

Το πρόγραμμα παράδοσης της αναβάθμισης θα χωριστεί στις τρεις φάσεις.

| Παράδοση αναβάθμισης | Φάση 1 (Ιανουάριος 2022) | Φάση 2 (Κύμα Απριλίου 2022) | Φάση 3 (Κύμα Απριλίου 2022) |
|------------------|------------------------|---------------------------|---------------------------|
...
| Επικυρώσεις | Φάση 1 (Ιανουάριος 2022) | Φάση 2 (Κύμα Απριλίου 2022) | Φάση 3 (Κύμα Απριλίου 2022) |
|-------------|------------------------|---------------------------|---------------------------|
...
| Το WBS θα επαληθευθεί στα γνωστά όρια του Project Desktop Client. | | :heavy_check_mark: | :heavy_check_mark: |
...
- Το περιβάλλον προορισμού πρέπει να ενημερωθεί στην Έκδοση ενημέρωσης 38 του Project Service Automation ή μεταγενέστερη έκδοση.
...
## <a name="end-to-end-testing-in-lower-environments"></a>Δοκιμές από άκρο σε άκρο σε χαμηλότερα περιβάλλοντα

### <a name="run-the-upgrade-in-production"></a>Εκτέλεση της αναβάθμισης στην παραγωγή
...
3. Αναβαθμίστε τις προσαρμοσμένες λύσεις, ανάλογα με την περίπτωση. Σε αυτό το σημείο, αναπτύξτε τις αλλαγές που έχετε κάνει στις προσαρμογές σας, στην ενότητα [Δοκιμή και επανασχεδιασμός προσαρμογών](#testing-and-refactoring-customizations) αυτού του θέματος.
...
| Διαχείριση και λογστική Finance Project              | Project Operations για σενάρια εφοδιασμένα/παραγγελίας παραγωγής | Δεν υποστηρίζονται αυτή τη στιγμή |
