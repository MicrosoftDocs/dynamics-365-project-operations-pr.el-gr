...
1. Στις καρτέλες **Ρόλος** , **Κατηγορία** και **Στοιχείο τιμοκαταλόγου** , μπορείτε να επιλέξετε **Ενημέρωση τιμών** για να εφαρμόσετε μια αύξηση για όλες τις τιμές στο υποπλέγμα. 
...
3. Επιλέξτε **OK** στη σελίδα παραθύρου διαλόγου και, στη συνέχεια, επαληθεύστε ότι οι τιμές στο υπο-πλέγμα απεικονίζουν τις αλλαγές που έχετε κάνει.
