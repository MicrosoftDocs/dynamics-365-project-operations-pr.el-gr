---
title: Τιμοκατάλογοι προϊόντων
description: Αυτό το άρθρο παρέχει πληροφορίες σχετικά με τους τιμοκαταλόγους στην τιμολόγηση καταλόγου που χρησιμοποιείται για προσφορές και συμβάσεις έργου.
author: rumant
ms.date: 04/05/2021
ms.topic: article
ms.prod: ''
