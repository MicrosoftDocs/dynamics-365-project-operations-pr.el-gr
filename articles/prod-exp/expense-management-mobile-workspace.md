...
- Βγάλτε μια φωτογραφία μιας απόδειξης και ανεβάστε την στο Dynamics 365 Finance. Στη συνέχεια, μπορείτε να επισυνάψετε αυτή τη φωτογραφία σε μια αναφορά εξόδων αργότερα.
