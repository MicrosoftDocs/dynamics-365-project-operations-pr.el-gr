...
description: Αυτό το άρθρο παρέχει πληροφορίες σχετικά με την επανασχεδιασμένη και ανασχεδιασμένη εμπειρία για καταχώρηση αναφοράς εξόδων.
author: ryansandness
ms.date: 06/14/2019
ms.topic: article
ms.prod: ''
