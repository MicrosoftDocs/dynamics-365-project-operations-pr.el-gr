...
description: Μπορείτε να ορίσετε τις πολιτικές δαπανών που θα πρέπει να ακολουθούν οι εργαζόμενοι κατά την εισαγωγή και την υποβολή αναφορών δαπανών και οδοιπορικών στο Microsoft Dynamics 365 Finance.
author: suvaidya
ms.date: 05/20/2020
ms.topic: article
ms.prod: ''
