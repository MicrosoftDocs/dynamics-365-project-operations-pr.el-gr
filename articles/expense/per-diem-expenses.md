...
description: Αυτό το θέμα παρέχει πληροφορίες σχετικά με τον τρόπο εργασίας με τις ημερήσιες δαπάνες.
author: suvaidya
ms.date: 03/18/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8596050"
---
# <a name="per-diem-expenses"></a>Ημερήσιες δαπάνες

> [!IMPORTANT] 
> Οι λειτουργίες που περιγράφονται σε αυτό το θέμα είναι διαθέσιμες στους στοχευμένους χρήστες ως μέρος μιας έκδοσης προεπισκόπησης.
