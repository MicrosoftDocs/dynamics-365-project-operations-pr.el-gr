...
description: Αυτό το άρθρο παρέχει πληροφορίες σχετικά με τον τρόπο με τον οποίο επιλύονται οι τιμές κόστους σε εκτιμήσεις έργου και οι πραγματικές τιμές.
author: rumant
ms.date: 04/07/2021
ms.topic: article
ms.prod: ''
