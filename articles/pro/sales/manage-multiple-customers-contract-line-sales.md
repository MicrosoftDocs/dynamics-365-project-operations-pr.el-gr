---
title: Διαχείριση πολλών πελατών σε γραμμές σύμβασης έργου
description: Αυτό το άρθρο παρέχει πληροφορίες σχετικά με τη διαχείριση πολλών πελατών σε γραμμές σύμβασης βάσει έργου.
author: rumant
ms.date: 10/27/2020
ms.topic: article
...
ms.locfileid: "9825940"
---
# <a name="manage-multiple-customers-on-project-contract-lines"></a>Διαχείριση πολλών πελατών σε γραμμές σύμβασης έργου
