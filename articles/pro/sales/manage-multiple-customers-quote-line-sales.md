---
title: Διαχείριση πολλών πελατών σε γραμμές προσφοράς έργου
description: Αυτό το άρθρο περιγράφει τον τρόπο διαχείρισης πολλών πελατών σε γραμμές προσφοράς έργου.
author: rumant
ms.date: 10/06/2020
ms.topic: article
