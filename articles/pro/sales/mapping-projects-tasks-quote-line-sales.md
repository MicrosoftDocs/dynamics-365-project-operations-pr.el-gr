---
title: Αντιστοίχιση έργων και εργασιών σε γραμμές προσφοράς έργου
description: Αυτό το άρθρο παρέχει πληροφορίες σχετικά με τον τρόπο αντιστοίχισης έργων και εργασιών σε γραμμές προσφοράς έργου.
author: rumant
ms.date: 10/05/2020
ms.topic: article
...
ms.locfileid: "9824271"
---
# <a name="map-projects-and-tasks-to-project-quote-lines"></a>Αντιστοίχιση έργων και εργασιών σε γραμμές προσφοράς έργου

_**Ισχύει για:** Εργασίες έργου για σενάρια βασισμένα σε πόρους/μη εφοδιασμένα, ανάπτυξη Lite - συμφωνία για προτιμολόγηση_

Σε γραμμές προσφοράς έργου, μπορείτε να αντιστοιχίσετε τις συγκεκριμένες εργασίες ενός έργου που έχει ήδη συσχετιστεί με μια γραμμή προσφοράς.
