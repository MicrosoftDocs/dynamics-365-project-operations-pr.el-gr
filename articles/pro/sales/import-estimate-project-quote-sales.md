---
title: Εισαγωγή εκτιμήσεων από έργο σε γραμμή προσφοράς έργου
description: Αυτό το άρθρο παρέχει πληροφορίες σχετικά με τον τρόπο εισαγωγής εκτιμήσεων από ένα έργο σε μια γραμμή προσφοράς έργου.
author: rumant
ms.date: 10/09/2020
ms.topic: article
...
ms.locfileid: "9824486"
---
# <a name="import-estimates-from-a-project-to-a-project-quote-line"></a>Εισαγωγή εκτιμήσεων από έργο σε γραμμή προσφοράς έργου 
