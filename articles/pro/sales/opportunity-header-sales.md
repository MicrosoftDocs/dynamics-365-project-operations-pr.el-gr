---
title: Λεπτομέρειες κεφαλίδας για ευκαιρίες έργου
description: Αυτό το άρθρο παρέχει πληροφορίες σχετικά με συμφωνίες βάσει έργου και γραμμές ευκαιριών βάσει έργου.
author: rumant
ms.date: 10/01/2020
ms.topic: article
...
ms.locfileid: "9824579"
---
# <a name="header-details-for-project-opportunities"></a>Λεπτομέρειες κεφαλίδας για ευκαιρίες έργου
