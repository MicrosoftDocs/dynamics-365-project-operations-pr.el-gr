---
title: Έννοιες μοναδικές για προσφορές έργου
description: Αυτό το άρθρο παρέχει πληροφορίες σχετικά με τη χρήση προσφορών έργου στο Project Operations.
author: rumant
ms.date: 10/01/2020
ms.topic: article
...
- Οι προσφορές του Sales σας επιτρέπουν να επισυνάψετε πολλαπλές παραγγελίες σε μία προσφορά πώλησης. Στο Project Operations, μόνο μία σύμβαση έργου μπορεί να επισυναφθεί σε μια προσφορά έργου.
