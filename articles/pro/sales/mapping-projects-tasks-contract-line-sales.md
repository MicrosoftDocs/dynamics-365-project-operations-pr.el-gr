---
title: Αντιστοίχιση έργων και εργασιών σε μια γραμμή σύμβασης έργου
...
ms.locfileid: "9825058"
---
# <a name="map-projects-and-tasks-to-a-project-contract-line"></a>Αντιστοίχιση έργων και εργασιών σε μια γραμμή σύμβασης έργου 
...
Σε γραμμές σύμβασης έργου, μπορείτε να αντιστοιχίσετε συγκεκριμένες εργασίες σε ένα έργο με τη γραμμή σύμβασης.
...
## <a name="associate-tasks-to-project-contract-lines"></a>Συσχετισμός εργασιών με γραμμές σύμβασης έργου
