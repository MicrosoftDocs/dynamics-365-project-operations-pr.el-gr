...
description: Αυτό το άρθρο περιγράφει την έννοια των οργανικών μονάδων και εξηγεί τον τρόπο δημιουργίας και συντήρησης οργανικών μονάδων στο Microsoft Dynamics 365 Project Operations.
author: rumant
ms.date: 1/31/2022
ms.topic: article
ms.author: rumant
