---
title: Διαχείριση πολλών πελατών σε προσφορά βάσει έργου
description: Αυτό το άρθρο παρέχει πληροφορίες σχετικά με την εργασία σε προσφορές που αφορούν πολλούς πελάτες που θα χρηματοδοτήσουν το έργο.
author: rumant
ms.date: 10/01/2020
ms.topic: article
...
ms.locfileid: "9825148"
---
# <a name="manage-multiple-customers-on-a-project-based-quote"></a>Διαχείριση πολλών πελατών σε προσφορά βάσει έργου

_**Ισχύει για:** Project Operations για σενάρια βασισμένα σε πόρους/μη εφοδιασμένα_

Οι προσφορές βάσει έργου υποστηρίζουν το σενάριο όπου η πρόταση περιλαμβάνει πολλούς πελάτες οι οποίοι θα χρηματοδοτήσουν τη συμφωνία. Η καρτέλα **Σύνοψη** της προσφοράς έχει το πεδίο **Πιθανός πελάτης** που προσδιορίζει τον κύριο πελάτη της συμφωνίας. Είναι δυνατή η ρύθμιση άλλων πελατών για τη συμφωνία στην καρτέλα **Πελάτες** της προσφοράς έργου.
