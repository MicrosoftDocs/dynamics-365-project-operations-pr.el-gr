...
Στην καρτέλα **Χρεώσιμοι ρόλοι** σε μια γραμμή σύμβασης βάσει έργου, στο υποπλέγμα **Χρεώσιμες κατηγορίες** στο πεδίο **Τύπος τιμολόγησης** ενημερώστε τον τύπο χρέωσης για έναν ρόλο.
...
Στην καρτέλα **Χρεώσιμες κατηγορίες** σε μια γραμμή σύμβασης βάσει έργου, στο υποπλέγμα **Χρεώσιμες κατηγορίες** στο πεδίο **Τύπος τιμολόγησης** ενημερώστε τον τύπο χρέωσης για μια συναλλαγή.
