...
description: Αυτό το άρθρο παρέχει πληροφορίες σχετικά με την εργασία με γραμμές σύμβασης και συμβάσεις που περιέχουν πολλούς πελάτες.
author: rumant
ms.date: 10/22/2020
ms.topic: article
