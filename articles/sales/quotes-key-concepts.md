...
description: Αυτό το άρθρο παρέχει πληροφορίες σχετικά με προσφορές έργου και προσφορές πωλήσεων που είναι διαθέσιμες στο Project Operations.
author: rumant
ms.date: 09/18/2020
ms.topic: article
ms.prod: ''
...
Αυτό το άρθρο εστιάζει στις λεπτομέρειες των προσφορών έργου.
