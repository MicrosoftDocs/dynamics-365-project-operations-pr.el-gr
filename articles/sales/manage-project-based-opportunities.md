---
title: Διαχείριση ευκαιριών έργου
description: Αυτό το άρθρο παρέχει πληροφορίες σχετικά με τον τρόπο εργασίας με ευκαιρίες που σχετίζονται με έργα.
author: rumant
ms.date: 10/21/2020
ms.topic: article
...
ms.locfileid: "9825303"
---
# <a name="manage-project-opportunities"></a>Διαχείριση ευκαιριών έργου
...
Οι ευκαιρίες βάσει 'εργων στο Dynamics 365 Project Operations έχουν σχεδιαστεί με επεκτάσεις στο Dynamics 365 Sales. Το άρθρο παρέχει λεπτομέρειες σχετικά με τα διαφορετικά πεδία και την επιχειρηματική λογική που περιλαμβάνονται στις πρόσθετες λειτουργίες που απαιτούνται από εταιρείες βάσει έργων για τη διαχείριση ευκαιριών βάσει έργων.
