...
1. Μεταβείτε στο [Κέντρο διαχείρισης του Microsoft 365](https://portal.office.com/) για να αναθέσετε τις άδειες χρήσης στους χρήστες σας.
...
### <a name="what-if-i-require-alm-or-elm-for-my-finance-and-operations-apps-environment"></a>Τι γίνεται εάν απαιτώ ALM ή ELM για το περιβάλλον εφαρμογών Finance and Operations μου;
...
1. Στο **Κέντρο διαχείρισης Microsoft 365**, μεταβείτε στο **Χρέωση** > **Τα προϊόντα σας**.
