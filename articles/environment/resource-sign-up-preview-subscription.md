...
3. Επαληθεύστε ότι έχει επιλεγεί η άδεια χρήσης **Προεπισκόπηση Dynamics 365 Project Operations (CRM)** και **Office 365 Project Operations - Προεπισκόπηση** και επιλέξτε **Αποθήκευση αλλαγών**.
