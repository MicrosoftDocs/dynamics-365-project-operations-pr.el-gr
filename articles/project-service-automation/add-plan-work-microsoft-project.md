...
3.  Όταν ολοκληρωθεί η λήψη, κάντε κλικ στο κουμπί **Ναι** για την εγκατάσταση του προσθέτου.  
...
### <a name="edit-in-pn_microsoft_project"></a>Επεξεργασία στο [!INCLUDE[pn_microsoft_project](../includes/pn-microsoft-project.md)]  
...
## <a name="upload-a-project-file-to-sharepoint-or-office-groups"></a>Αποστολή αρχείου Project στο SharePoint ή σε Ομάδες Office  
 Μπορείτε να στείλετε το αρχείο έργου στο SharePoint και να το βρείτε κάτω από τα έγγραφα που σχετίζονται με το έργο [!INCLUDE[pn_project_service_auto](../includes/pn-project-service-auto.md)].  Ο διαχειριστής σας πρέπει να ρυθμίσει τις παραμέτρους διαχείρισης εγγράφων του SharePoint και να ενεργοποιήσει αυτή τη δυνατότητα για την οντότητα Project. [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [Ρύθμιση ενοποίησης SharePoint](../admin/set-up-sharepoint-integration.md)  

 Επίσης, μπορείτε να αποστείλετε το αρχείο έργου στο [!INCLUDE[pn_onedrive_for_business](../includes/pn-onedrive-for-business.md)], εάν έχετε ορίσει Ομάδες Office. [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [Συνεργαστείτε με τους συναδέλφους σας χρησιμοποιώντας Ομάδες Office 365](../basics/collaborate-with-colleagues-using-office-365-groups.md)  
